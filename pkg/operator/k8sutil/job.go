...
var logger = capnslog.NewPackageLogger("topolvm/operator", "op-k8sutil")
...
func RunReplaceableJob(clientset kubernetes.Interface, job *batch.Job, deleteIfFound bool) error {
	...
	if err != nil && !errors.IsNotFound(err) {
		...
		// make sure job completion
		if err := WaitForJobCompletion(clientset, existingJob, time.Hour*1); err != nil {
