...
var logger = capnslog.NewPackageLogger("topolvm/operator", "topolvm-spec")
...
func buildFinalizerName(kind string) string {
	return fmt.Sprintf("%s.%s", strings.ToLower(kind), apis.CustomResourceGroup)
}
